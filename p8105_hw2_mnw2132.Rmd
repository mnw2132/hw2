...
The final data set includes `r nrow(all_tidy_trash)` and `r ncol(all_tidy_trash)` and has each person's information lined up according to each season and episode they were in. 
