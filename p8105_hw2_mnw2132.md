...
The final data set includes 228 rows and 5 columns and has each person’s
information lined up according to each season and episode they were in.
...
```
    ...
    ##    series episode baker    technical result    
    ##     <dbl>   <dbl> <chr>        <dbl> <chr>     
    ##  1      9       1 Manon            3 STAR BAKER
    ##  2      9       2 Rahul            2 STAR BAKER
    ##  3      9       3 Rahul            4 STAR BAKER
    ##  4      9       4 Dan              1 STAR BAKER
    ##  5      9       5 Kim-Joy          4 STAR BAKER
    ##  6      9       6 Briony           1 STAR BAKER
    ##  7      9       7 Kim-Joy          6 STAR BAKER
    ##  8      9      10 Rahul            2 WINNER    
    ##  9     10       1 Michelle         6 STAR BAKER
    ## 10     10       2 Alice            1 STAR BAKER
    ## 11     10       4 Steph            1 STAR BAKER
    ## 12     10       5 Steph            4 STAR BAKER
    ## 13     10       6 Steph            3 STAR BAKER
    ## 14     10       7 Henry            3 STAR BAKER
    ## 15     10       8 Steph            4 STAR BAKER
    ## 16     10       9 Alice            4 STAR BAKER
...
The average viewership in season 1 was `print(season_1)` and for season
5 it was `print(season_5)`.
