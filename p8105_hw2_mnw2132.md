...
bakers = read_csv(file = "/Users/nickywilliams/Desktop/hw2/gbb_datasets/bakers.csv", na = c(".","NA","")) %>%
  janitor::clean_names()
```
...
bakes = read_csv(file = "/Users/nickywilliams/Desktop/hw2/gbb_datasets/bakes.csv", na = c(".","NA","")) %>%
  janitor::clean_names()
```
...
results = read_csv(file = "/Users/nickywilliams/Desktop/hw2/gbb_datasets/results.csv", na = c(".","NA",""), skip=2) %>%
  janitor::clean_names()
```
